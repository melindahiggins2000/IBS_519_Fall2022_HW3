...
### Identify the abalones with shuckedWeight > wholeWeight

```{r}
# PUT YOUR CODE HERE
```

### Identify the abalones with visceraWeight > wholeWeight

```{r}
# PUT YOUR CODE HERE
```

### Identify the abalones with shellWeight > wholeWeight

```{r}
# PUT YOUR CODE HERE
```

### Show the abalones that have shuckedWeight > wholeWeight
...
### Summary statistics of the 4 Weight Measurements by Sex
